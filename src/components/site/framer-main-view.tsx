...
function injectStyles(document: Document, replacement: HomepageComponentReplacement) {
  ...
  style.textContent = [
    ...
    ".framer-1k80cd9 { padding: 20px clamp(12px, 2vw, 20px) !important; row-gap: 12px !important; }",
    ".framer-1k80cd9 h1, .framer-1k80cd9 h2, .framer-1k80cd9 p, .framer-1k80cd9 a { font-family: var(--font-onest, Inter, Arial, sans-serif) !important; letter-spacing: -0.02em !important; line-height: 1.18 !important; }",
    ".framer-1k80cd9 h1 { font-size: clamp(1.05rem, 1.45vw, 1.55rem) !important; font-weight: 600 !important; }",
    ".framer-1k80cd9 p, .framer-1k80cd9 a { font-size: clamp(.68rem, .82vw, .82rem) !important; font-weight: 500 !important; }",
    ".framer-1k80cd9 [data-framer-name='RDR'] p { font-size: clamp(5rem, 12vw, 10rem) !important; line-height: .9 !important; letter-spacing: -.08em !important; }",
    "[data-framer-name='Section - Category'] { height: auto !important; min-height: 0 !important; padding: 24px 0 24px !important; }",
    "[data-framer-name='Section - Category'] > .framer-1xewl4e-container { height: clamp(430px, 40vw, 520px) !important; min-height: clamp(430px, 40vw, 520px) !important; overflow: visible !important; }",
    "[data-framer-name='Section - Category'] > .framer-1xewl4e-container > div { height: 100% !important; min-height: 0 !important; overflow: hidden !important; }",
    "@media (max-width: 640px) { .framer-1k80cd9 { padding: 16px 12px !important; row-gap: 10px !important; } .framer-1k80cd9 h1 { font-size: .95rem !important; } .framer-1k80cd9 p, .framer-1k80cd9 a { font-size: .68rem !important; } [data-framer-name='Section - Category'] { padding: 16px 0 16px !important; } [data-framer-name='Section - Category'] > .framer-1xewl4e-container { height: 430px !important; min-height: 430px !important; } }",
