...
function injectStyles(document: Document, replacement: HomepageComponentReplacement) {
  ...
  style.textContent = [
    ...
    "@media (max-width: 640px) { .framer-1k80cd9 { padding: 16px 12px !important; row-gap: 10px !important; } [data-framer-name='Section - Category'] { padding: 16px 0 16px !important; } [data-framer-name='Section - Category'] > .framer-1xewl4e-container { height: 430px !important; min-height: 430px !important; } }",
