...
export function MotherlandPage() {
  return (
    <main className="motherland-page">
      ...
      <section className="motherland-hero" aria-labelledby="motherland-title">
      ...
      <section className="motherland-manifesto" aria-labelledby="motherland-manifesto-title">
      ...
      <section className="motherland-playlist" aria-labelledby="motherland-playlist-title">
      ...
      <section className="motherland-cta" aria-labelledby="motherland-cta-title">
      ...
      <section className="motherland-network" aria-labelledby="motherland-network-title">
